...
with source as (
    select * from {{ ref('DIM_Review_Scores') }}
),
...
unknown as (
    select
        ...
        0.0                 as REVIEW_SCORES_RATING             ,
        0.0                 as REVIEW_SCORES_ACCURACY           ,
        0.0                 as REVIEW_SCORES_CLEANLINESS        ,
        0.0                 as REVIEW_SCORES_CHECKIN            ,
        0.0                 as REVIEW_SCORES_COMMUNICATION      ,
        0.0                 as REVIEW_SCORES_VALUE              ,
